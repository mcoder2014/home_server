...
function createAccountsApi(transport, getCSRF) {
    ...
    return {
        ...
        uploadAvatar: (revision, form) => request('post', '/api/account/avatar', form, revision),
        removeAvatar: revision => request('delete', '/api/account/avatar', undefined, revision),
        sessions: params => request('get', '/api/account/sessions', undefined, undefined, params),
        revokeSessions: sessionIDs => request('post', '/api/account/sessions/revoke', {session_ids: sessionIDs}),
        revokeOtherSessions: () => request('post', '/api/account/sessions/revoke-others'),
        ...
        userSessions: (userID, params) => request('get', `/api/admin/users/${id(userID)}/sessions`, undefined, undefined, params),
